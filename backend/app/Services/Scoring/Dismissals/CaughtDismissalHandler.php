...
class CaughtDismissalHandler implements DismissalHandlerInterface
{
    public function apply(DeliveryInput $input): DismissalOutcome
    {
        return new DismissalOutcome(creditedToBowler: true, requiresFielder: true, allowedOnFreeHit: false);
    }
}
